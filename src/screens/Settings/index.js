  ...
  return (
    <Container>
      ...
      <Profile onPress={() => navigation.navigate('EditUser')}>
        ...
        <ProfileInfo>
          <CustomText ft={20} txtColor="white">
            {user.username}
          </CustomText>
          <CustomText ft={18} txtColor="white">
            {user.phone}
          </CustomText>
          <CustomText ft={18} txtColor="white">
            {user.email}
      ...
      <CustomText txtColor="black" ft={25}>
      ...
      <Buttons>
        <Icon>
          ...
          <CustomText ft={20} txtColor="text">
            Conta
          </CustomText>
        </Icon>
        <Ionicons name="chevron-forward" size={35} color="text" />
      </Buttons>
      <Buttons onPress={() => navigation.navigate('Acessibility')}>
        <Icon>
